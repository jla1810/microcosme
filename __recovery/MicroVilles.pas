...
function  ChercherChef(V: TCity): TCreature;      // ★Phase C
function  EloireChef(V: TCity): Boolean;          // ★Phase C (élection/succession/triche)
procedure DrawCouronnes(C: TCanvas; OX, OY, S, VX0, VY0, VX1, VY1: Double);  // ★Phase C
